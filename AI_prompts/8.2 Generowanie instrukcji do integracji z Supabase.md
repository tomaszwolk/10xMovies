Na podstawie poniższego prompta wygeneruj instrukcję do integracji z Supabase na podstawie mojego @tech-stack.md.
...
Upewnij się, że wszytko jest zgodne z @db-plan.md i @prd.md.

Plik zapisz w .cursor\rules\api-supabase-django-react-init-mdc