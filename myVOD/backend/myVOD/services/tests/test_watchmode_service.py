...
class WatchmodeServiceTests(TestCase):
    ...
    def test_get_title_details_success(self, mock_get):
        ...
        # Act
        result = service.get_title_details(title_id=12345, region='PL')

        # Assert
        self.assertIsNotNone(result)
        self.assertEqual(result["title"], "Test Movie")
        mock_get.assert_called_once()
        # Check that region parameter was passed correctly
        self.assertEqual(mock_get.call_args.kwargs['params']['region'], 'PL')
    ...
    def test_get_source_changes_success(self, mock_get):
        ...
        # Act
        result = service.get_source_changes(start_date='2025-10-23', end_date='2025-10-24', region='PL')
